...
if __name__ == "__main__":
	...
	parser.add_argument("--transfer_env", default=None)                       # Add environment if we want to transfer from previously trained model
	...
	# Initialize policy
        ...
        if args.transfer_env is not None:
            transfer_model = args.policy_name+"_"+args.transfer_env+"_"+str(args.seed)
	...
	if args.policy_name == "TD3": policy = TD3.TD3(state_dim, action_dim,max_action,transfer_model,transfer_state_dim,transfer_action_dim)
	elif args.policy_name == "OurDDPG": policy = OurDDPG.DDPG(state_dim, action_dim, max_action,transfer_model,transfer_state_dim,transfer_action_dim)
